class ProductDetailAlsoBoughtModel {
  List<List1>? list1;
  int? count;
  int? total;
  int? currentPage;
  ...
  ProductDetailAlsoBoughtModel.fromJson(Map<String, dynamic> json) {
...
class List1 {
  ...
  List1.fromJson(Map<String, dynamic> json) {
    ...
    productsImageTitle1 = json['products_image_title1'];
